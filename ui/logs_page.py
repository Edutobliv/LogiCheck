...
# Colores de acción para la tabla
ACTION_COLORS = {
    "Inicio de Sesión":           "#a6e3a1",   # verde
    "Intento de Acceso Fallido":  "#f38ba8",   # rojo fuerte
    ...
    "Resultado de Análisis":      "#94e2d5",   # teal
    ...
    "Usuario Activado":           "#a6e3a1",   # verde
    "Contraseña Cambiada":        "#cba6f7",   # púrpura
}
...
class LogsPage(QWidget):
    ...
    def _build_ui(self):
        ...
        self._card_total   = self._make_stat_card("📋", "0", "Eventos Hoy",      "#89b4fa")
        self._card_logins  = self._make_stat_card("🔑", "0", "Inicios Hoy",      "#a6e3a1")
        self._card_users   = self._make_stat_card("👤", "0", "Usuarios Activos",  "#cba6f7")
    ...
    def refresh(self):
        ...
        for row_idx, log in enumerate(logs):
            ...
            id_item.setForeground(QColor("#585b70"))
            ...
            ts_item.setForeground(QColor("#a6adc8"))
            ...
            uname_item.setForeground(QColor("#89b4fa"))
            ...
            desc_item.setForeground(QColor("#a6adc8"))
